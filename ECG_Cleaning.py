...
#4.3.2 ecg subset
#Chose 5000 to 10000 since there is a significant spike before and after these values
...
#Subtracting the mean to center all values around 0
...
#4.3.8 Plotting the first 500 point segments for both smoothed and original
...
#Creating a csv with the cleaned data
